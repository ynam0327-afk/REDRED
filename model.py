{
  ...
  "metadata": {
    "colab": {
      "provenance": [],
      "mount_file_id": "https://github.com/ynam0327-afk/REDRED/blob/main/model.ipynb",
      "authorship_tag": "ABX9TyN0Hv3XHcGSveyqSWBq5Di8",
  ...
  "cells": [
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "N7N2oqPIB1T_",
        "outputId": "b51f22cb-9d8d-4150-a785-5e5330a6036e"
      },
      "outputs": [
        {
          "output_type": "stream",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "qHHcb051runq",
        "outputId": "453d91d6-da33-4b48-be59-303d7af403ef"
      },
      ...
      "outputs": [
        {
          ...
          "text": [
            ...
            "  피처: {'url_length': 52, 'domain_length': 32, 'dot_count': 2, 'slash_count': 4, 'hyphen_count': 3, 'digit_count': 2, 'contains_at': 0, 'has_ip': 0, 'https_flag': 0, 'shortener': 0, 'suspicious_word_count': 4}\n",
            "  모델 위험도: 0.6067\n",
            "\n",
            "\n",
            "=== final_alert_score 시나리오 검증 ===\n",
            "[완전 매칭 + 안전 URL] {'disaster_reliability_score': 0.916, 'disaster_reliability_note': None, 'url_risk_score': 0.0, 'final_score': 0.95, 'decision': 'approve'}\n",
            "[정보부족 + 안전 URL] {'disaster_reliability_score': 0.5, 'disaster_reliability_note': '정보 부족 - 관할 시군구에 대응하는 소방청 사건 없음 (판단보류, 위험 아님)', 'url_risk_score': 0.0, 'final_score': 0.7, 'decision': 'approve'}\n",
            "[정보부족 + 위험 URL] {'disaster_reliability_score': 0.5, 'disaster_reliability_note': '정보 부족 - 관할 시군구에 대응하는 소방청 사건 없음 (판단보류, 위험 아님)', 'url_risk_score': 1.0, 'final_score': 0.3, 'decision': 'reject'}\n",
            "[지역만 일치 + 안전 URL] {'disaster_reliability_score': 0.61, 'disaster_reliability_note': None, 'url_risk_score': 0.0, 'final_score': 0.766, 'decision': 'approve'}\n"
          ]
        }
      ]
    }
